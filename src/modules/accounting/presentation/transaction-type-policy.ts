...
const LOANS_TO_OTHERS_TRANSACTION_TYPES = TODO_ACCOUNT_TRANSACTION_TYPES;
const UNCATEGORIZED_ASSET_TRANSACTION_TYPES = TODO_ACCOUNT_TRANSACTION_TYPES;
const UNDEPOSITED_FUNDS_TRANSACTION_TYPES = TODO_ACCOUNT_TRANSACTION_TYPES;
